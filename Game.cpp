...
INT WINAPI WinMain (HINSTANCE hInstance, HINSTANCE hPrevInst,LPSTR lpCmdLine, int nShowCmd)
{
 ...
 game=new cGame();
  /* Create window */
 game->CreateGameWindows(hInstance," Linear Algebra Tutorial  : Arbitrary axis Rotation simulation");
